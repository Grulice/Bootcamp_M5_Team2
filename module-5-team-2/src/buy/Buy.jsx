...
class Buy extends React.Component{
    ...
    render() {
        return(
         <MainBuy>
             <HeaderBuy>
                 <Link to={'/Stock'}><img src={arrow} alt="arrow"/>Back</Link>
             ...
             <CentralBlock>
                 ...
                 <InputBlock>
                     ...
                     <input type="text" onChange={this.changeValue} value={this.state.pieces}/>
                     <p onClick={this.handlerPlus}>+</p>
                 </InputBlock>
                 <BuyFor>Buy for {(this.state.pieces*this.state.price).toFixed(2)}$</BuyFor>
                 <Link to={'/Stock'}>
